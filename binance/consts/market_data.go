...
const (
	// FApiDataDeliveryPrice 季度合约历史结算价
	FApiDataDeliveryPrice = "/futures/data/delivery-price"

	// FApiDataOpenInterestHist 合约持仓量历史
	FApiDataOpenInterestHist = "/futures/data/openInterestHist"
